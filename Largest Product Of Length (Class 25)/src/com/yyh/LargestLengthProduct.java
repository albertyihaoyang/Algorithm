...
public class LargestLengthProduct {
	public int largestProduct(String[] dict) {
		// Assumptions: dict is not null and has length >= 2, there is no null String in the dict.
		// The words in the dict only use characters 'a'-'z'
		// Get the bit mask for each of the word in the dict, the bit mask is represented by the lowest 26 bits of an integer
		// the bit mask is represented by the lowest 26 bits of an integer.
		// each of the represents one of the characters in 'a'-'z'.
